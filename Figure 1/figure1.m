...
printPNG(figure(1),'../plot/1_Diagnosis_PB.png')
printPNG(figure(2),'../plot/1_Diagnosis_BM.png')
printPNG(figure(3),'../plot/1_Relapse.png')
printPNG(figure(4),'../plot/1_Remission.png')
