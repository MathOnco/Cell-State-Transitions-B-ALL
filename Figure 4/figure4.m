...
for row = 1:1:length(B)
    ...
    if strcmp(DP{row},'Remission')
        color = gray;
        j = 3;
    elseif strcmp(B{row},'BCR::ABL1') || strcmp(B{row},'BCR::ABL1-like')
...
printPNG(figure(1),'../plot/4-waterfall-BCR.png')
printPNG(figure(2),'../plot/4-waterfall-MRD.png')
printPNG(figure(3),'../plot/4-waterfall-Relapse.png')

printPNG(figure(11),'../plot/4-violin-BCR.png')
printPNG(figure(12),'../plot/4-violin-MRD.png')
printPNG(figure(13),'../plot/4-violin-Relapse.png')
